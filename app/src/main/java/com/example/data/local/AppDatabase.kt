...
/**
 * Room database holder for Sana'a Chase High Scores, Missions and Top Players.
 */
@Database(entities = [HighScoreEntity::class, GameMissionEntity::class], version = 3, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
  abstract fun highScoreDao(): HighScoreDao
  abstract fun gameMissionDao(): GameMissionDao
          ...
          .addCallback(object : Callback() {
            override fun onCreate(db: SupportSQLiteDatabase) {
              ...
              CoroutineScope(Dispatchers.IO).launch {
                ...
                val missionDao = getDatabase(context).gameMissionDao()
                val seedMissions = listOf(
                  GameMissionEntity(
                ...
                missionDao.insertAll(seedMissions)
              }
            }
          })
          .build()
